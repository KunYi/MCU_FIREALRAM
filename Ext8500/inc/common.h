...
/* ===================================================================
  ...
  ================================================================= */
#define _Keil_       /* defined use Compile */
...
#define EXTERN_DATA        xdata
#define P_EXTERN_DATA      pdata
#define DIRECT_BYTE_IO(PORT)  ((unsigned char  volatile xdata *) 0) [(PORT)] 
#define DIRECT_WORD_IO(PORT)  ((unsigned int  volatile xdata *) 0) [(PORT)]
#define SET_REGISTER(reg) reg = ENABLE
#define RESET_REGISTER(reg) reg = DISABLE
