...
static EXTERN_DATA BYTE PreKey;
     ...
     /* Key moudle 4 only bit 0,1,2,3 is key button */
      ...
      if (KeyM1 != 0xff)
        { if ((KeyM2 == 0xff) && (KeyM3 == 0xff) && (KeyM4 == 0xff) && (KeyM5 == 0xff))
            { for ( i = 0; i < 8; i++)
                 { if (KeyM1== ~KeyTable[i]) { KeyValue = i; break; } } 
            }
          else { KeyTrue = KeyPush = FALSE; return; }
        }
     else
        { if (KeyM2 != 0xff)
            { if ((KeyM3 == 0xff) && (KeyM4 == 0xff && (KeyM5 == 0xff)))
                {  for ( i = 0; i < 8; i++)
                      {  if (KeyM2 == ~KeyTable[i]) {  KeyValue = i+8; break; } } 
                }
              else { KeyTrue = KeyPush = FALSE; return; }
            }
          else 
          { 
           ...
           { if (KeyM4 != 0xff)
                {if (KeyM5 == 0xff)
                   {for ( i = 0; i < 8; i++) 
 	                     { if (KeyM4 == ~KeyTable[i]) { KeyValue = i+24; break; } } 
                    }
                 else { KeyTrue = KeyPush = FALSE; return; }
              }
           ...
           {if (KeyM5 != 0xff)
                {for ( i = 0; i < 8; i++) 
                     { if (KeyM5 == ~KeyTable[i]) { KeyValue = i+32; break; } } 
                   }
                     else { KeyTrue = KeyPush = FALSE; return; }
             }
          }
